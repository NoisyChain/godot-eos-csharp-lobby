...
#if UNITY_EDITOR_WIN || GODOT_WINDOWS
...
#elif UNITY_EDITOR_OSX || UNITY_STANDALONE_OSX || GODOT_MACOS
	#define EOS_PLATFORM_OSX

#elif UNITY_EDITOR_LINUX || UNITY_STANDALONE_LINUX || GODOT_LINUXBSD
	#define EOS_PLATFORM_LINUX

#elif UNITY_IOS || GODOT_IOS || __IOS__
	#define EOS_PLATFORM_IOS

#elif UNITY_ANDROID || GODOT_ANDROID || __ANDROID__
